...
"""Verify that starting lockelycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lockelycoin with -h for help text")
        ...
        self.log.info("Start lockelycoin with -version for version information")
        ...
        self.log.info("Start lockelycoind with -fakearg to make sure it does not start")
