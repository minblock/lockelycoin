# Support for Output Descriptors in lockelycoin Core

Since lockelycoin Core v0.17, there is support for Output Descriptors. This is a
...
on lockelycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing lockelycoin Core wallets, a convenience function `combo` is
