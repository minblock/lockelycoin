...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lockelycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lockelycoin-tx [options] <hex-tx> [commands]  Update hex-encoded lockelycoin transaction\n" +
            "or:     lockelycoin-tx [options] -create [commands]   Create hex-encoded lockelycoin transaction\n" +
            "\n";
