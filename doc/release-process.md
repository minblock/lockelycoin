...
* Update manpages, see [gen-manpages.sh](https://github.com/lockelycoin-project/lockelycoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/lockelycoin-project/gitian.sigs.ltc.git
    git clone https://github.com/lockelycoin-project/lockelycoin-detached-sigs.git
...
- Detached signatures will then be committed to the [lockelycoin-detached-sigs](https://github.com/lockelycoin-project/lockelycoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/lockelycoin-project/lockelycoin/releases/new) with a link to the archived release notes.
